...
Where "your_key_here" is your Flickr API key. See http://flickr.com/services/api/keys/apply/ for info on getting yourself a key. These should be the same 10 photos as if you went to the flickr homepage and typed "pizza" into the search box.

The results of this search on your page looks like:
...
Once you have that ID you can search only your own photos that are tagged with 'waterfall':
